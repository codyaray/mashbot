...
\perlnewcommand{\listsomething}[1]{
	$returning = "";
	foreach(@_[0]){
		$returning = $returning . $_;
	}
	return returning;
}
...
\subsubsection{Feature: Push Status}
	...
	least the status field in the object model}{And I have not filled in at 
	  least the status field in the object model}{to}{I want to be able to get the ids for each individual status posted to each service that I specify.}
