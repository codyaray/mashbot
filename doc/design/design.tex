...
of hard coding into the code what the next handler will be for each. 
		...
		\subsection{Handlers}
			\subsubsection{Handler}
				...
				\begin{figure}[h!] \centering \includegraphics{uml/Handlers.1} \end{figure}
                                \clearpage
			\subsubsection{ChainableHandler}
				...
				\begin{figure}[h!] \centering \includegraphics{uml/Handlers.2} \end{figure}
                                \clearpage
			\subsubsection{AuthenticationHandler}
				...
				\begin{figure}[h!] \centering \includegraphics{uml/Handlers.3} \end{figure}
                                \clearpage
			\subsubsection{SerializationHandler}
				...
				\begin{figure}[h!] \centering \includegraphics{uml/Handlers.4} \end{figure}
                                \clearpage
			...
			\begin{figure}[h!] \centering \includegraphics{uml/Handlers.5} \end{figure}
                        \clearpage
			...
			\begin{figure}[h!] \centering \includegraphics{uml/Handlers.6} \end{figure}

			\clearpage

			\subsubsection{Overall}

			\begin{figure}[h!] \centering \includegraphics{uml/Handlers.7} \end{figure}
                        \clearpage
				...
				\begin{call}{serial}{Verify Data}{ver}{}
					...
					\begin{call}{ver}{Process the Request}{proc}{}
						\begin{call}{proc}{Run Request}{svc}{}
							\begin{call}{svc}{Grab Authentication}{auth}{}
							\end{call}
						\end{call}
					\end{call}
				\end{call}
