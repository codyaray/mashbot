...
\chapter{Publishing and Aggregation Platform}
	...
	\section{Server Design}
		\subsection{Platform}
			...
			request is passed to the handler chain when a request is made. Most 
		...
		\subsection{HandlerChain}
			This class embodies the link list that is the Handler. It will the pass 
			the request information to the first Handler and then that handler will 
			call each subsequent handler in the chain. This class will also handler 
			initializing the 
